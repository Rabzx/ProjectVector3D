...
public class Vector3DTest {
    ...
    public void testLength() {
        ...
        double expResult = Math.sqrt(2.0*2.0+3.0*3.0+4.0*4.0);
    ...
    public void testAdd() {
        ...
        Vector3D instance = new Vector3D(2.0, 3.0, 4.0);
        Vector3D expResult = new Vector3D(2.0+2.0, 3.0+3.0, 4.0+4.0);
    ...
    public void testMultiplyByScalar() {
        ...
        double alpha = 2.0;
        Vector3D instance = new Vector3D(2.0, 3.0, 4.0);
        Vector3D expResult = new Vector3D(alpha*2.0, alpha*3.0, alpha*4.0);
    ...
    public void testDotProduct() {
        ...
        Vector3D anotherVector = new Vector3D(2.0, 3.0, 4.0);
        Vector3D instance = new Vector3D(2.0, 3.0, 4.0);
        double expResult = 2.0*2.0 + 3.0*3.0 + 4.0*4.0;
    ...
    public void testEquals() {
        ...
        Object anotherObject = new Vector3D(2.0, 3.0, 4.0);
        Vector3D instance = new Vector3D(2.0, 3.0, 4.0);
